<?php
	...
	$qry1 = "SELECT * FROM posts_tbl WHERE category='Trending1' and status='Published' ORDER BY id DESC LIMIT 1";
	$rs1  = mysqli_query($conn,$qry1);

	$qry2 = "SELECT * FROM posts_tbl WHERE category='Trending2' and status='Published' ORDER BY id DESC LIMIT 1";
	$rs2  = mysqli_query($conn,$qry2);

	$qry3 = "SELECT * FROM posts_tbl WHERE category='Trending3' and status='Published' ORDER BY id DESC LIMIT 1";
	$rs3  = mysqli_query($conn,$qry3);

	$qry4 = "SELECT * FROM posts_tbl WHERE category='Trending4' and status='Published' ORDER BY id DESC LIMIT 1";
	$rs4  = mysqli_query($conn,$qry4);

	$qry5 = "SELECT * FROM posts_tbl WHERE category='Trending5' and status='Published' ORDER BY id DESC LIMIT 1";
	$rs5  = mysqli_query($conn,$qry5);

	$qry6 = "SELECT * FROM posts_tbl WHERE category='Trending6' and status='Published' ORDER BY id DESC LIMIT 1";
	$rs6  = mysqli_query($conn,$qry6);

	$qry7 = "SELECT * FROM posts_tbl WHERE category='Trending7' and status='Published' ORDER BY id DESC LIMIT 1";
	$rs7  = mysqli_query($conn,$qry7);

	$qry8 = "SELECT * FROM posts_tbl WHERE category='Trending8' and status='Published' ORDER BY id DESC LIMIT 1";
	$rs8  = mysqli_query($conn,$qry8);

	$qry9 = "SELECT * FROM posts_tbl WHERE category='Trending9' and status='Published' ORDER BY id DESC LIMIT 1";
	$rs9  = mysqli_query($conn,$qry9);

	$qry = "SELECT * FROM posts_tbl WHERE category='Latest' and status='Published' ORDER BY id DESC LIMIT 12";
			...
			<section class="main-section">
				<div class="row">
					<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
						<form method="get" action="search" class="form-search-box mb-4 d-none" id="search-box">
							<div class="row">
				...
				<div class="row">
					<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
						<div class="trending-section">
							<h3 class="page-title">Trending <i class="fas fa-fire"></i></h3>
							<div class="row">
								<div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4">
									<div id="slide1" class="carousel slide mb-4" data-ride="carousel">
										...
										<div class="carousel-inner">
											...
											<div class="carousel-item active">
												<a href="view-post?id=<?php echo $row['id'] ?>" class="post-img-block">
													<?php echo "<img src='img/".$row['img1']."' class='d-block w-100 post-img' width='150' >" ?>
        										</a>
      										</div>
      										<?php
  													}
								...
								<div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4">
									<div id="slide2" class="carousel slide mb-4" data-ride="carousel">
										<ol class="carousel-indicators mb-0">
								...
								<div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4">
									<div id="slide3" class="carousel slide mb-4" data-ride="carousel">
										<ol class="carousel-indicators mb-0">
				...
				<div class="row">
					<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
						<div class="latest-section">
							<h3 class="page-title">Latest <i class="fas fa-bolt"></i></h3>
							<div class="row">
								<?php
										...
										<div class="card-body">
											...
											<div class="row mx-0" style="margin-bottom: 12px;">
												<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 px-0">
													<p class="card-text"><a href="https://twitter.com/TechNotify_in" class="author-link"><?php echo $row['author'] ?></a><span class="post-time"><?php $date=$row['doi']; echo date("F d, Y", strtotime($date)); ?></span></p>
												</div>
											</div>
											<div class="post-feedback">

												<div class="feedback-group pr-xl-4 pr-lg-4 pr-md-4 pr-sm-5 pr-5" id="like">
													<form style="display: inline;" method="post">
														...
														<?php
															if (isset($_SESSION['userid'])) 
															{
    															...
    															{	
																	echo '<button id="likebtn" type="submit" name="dislike" class="feedback-btn" id="like-btn"><i class="fa-heart fas far"></i></button>';
																}
																else
																{
																	echo '<button id="likebtn" type="submit" name="like" class="feedback-btn" id="like-btn"><i class="fa-heart far"></i></button>';
																}
															}
															else
															{
												...
												<div class="feedback-group pr-xl-4 pr-lg-4 pr-md-4 pr-sm-5 pr-5">
													...
													<div class="dropdown-menu comment-dropdown" aria-labelledby="comment-btn">
														<?php
															$qry12 = "SELECT * FROM comments_tbl WHERE post_id=$postid and status='Active' ORDER BY id DESC LIMIT 6";
												...
												<div class="feedback-group pr-xl-4 pr-lg-4 pr-md-4 pr-sm-5 pr-5">
													...
													<div class="dropdown-menu" aria-labelledby="share-btn">
														<span class="dropdown-item text-center">
															...
															<a href="whatsapp://send?text=https://technotify.in/view-post?id=<?php echo $row['id'] ?>" data-action="share/whatsapp/share" class="share-icon"><i class="fab fa-whatsapp"></i></a>
														</span>
													</div>
												</div>
