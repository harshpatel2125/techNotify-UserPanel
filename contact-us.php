...
<head>
	...
	<title>Contact | Tech Notify</title>
  					...
  					<li class="nav-item dropdown active">
  						...
  						<div class="dropdown-menu" aria-labelledby="dropmore">
							...
							?>
  							...
  							<a href="contact-us" class="dropdown-item active">Contact Us</a>
  						</div>
  					</li>
  					<?php
  					if(isset($_SESSION['userid'])){
	...
	<main style="padding-top: 72px">
		<div class="container">
			<section class="main-section">
				...
				<div class="row">
					<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
						<div class="about-us-section" style="margin-bottom: 75px;">
							<div class="row">
								<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
									<h3 class="page-title">Contact Us</h3>
									<p class="about-us-text">If you’d like to get in touch with us, feel free to write us at <span class="theme-green">contact@technotify.in</span></p>
									<p class="about-us-text mt-5">You can a fill out our online form to get in touch.</p>
									<a href="#" class="btn theme-btn-inverse">Form</a>
