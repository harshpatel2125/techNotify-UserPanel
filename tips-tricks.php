<?php
	...
	$qry = "SELECT * FROM posts_tbl WHERE category='Tips & Tricks' and status='Published' ORDER BY id DESC LIMIT 12";
				...
				<div class="row">
					<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
						<div class="latest-section">
							<h3 class="page-title">Tips & Tricks <i class="far fa-lightbulb"></i></h3>
							<div class="row">
								<?php
...
<?php	
	if (isset($_POST['comment-submit'])) 
	{
		...
		if ($res) 
		{
			echo '<script>window.location.href = "tips-tricks"</script>';
		}
		else
		{
