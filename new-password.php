...
<body>
	<div class="signin-form">
		...
		<h4 class="signin-txt">Create New Password</h4>
		<form method="post">
			<input type="password" name="password" placeholder="New Password" class="form-control theme-txtbox" style="margin-bottom: 20px;" required>
			<input type="password" name="confirm-password" placeholder="Confirm Password" class="form-control theme-txtbox" required>
			<small class="form-text text-muted ml-2" style="color: #afafaf !important;">Passwords didn't match</small>
