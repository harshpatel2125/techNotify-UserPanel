  					...
  					<li class="nav-item dropdown active">
  						...
  						<div class="dropdown-menu" aria-labelledby="dropmore">
  							...
  							<?php
								...
								echo '<a href="bookmark" class="dropdown-item search-class active">Bookmark</a>';}
							?>
				...
				<div class="row">
					<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
						<div class="latest-section">
							<h3 class="page-title">Bookmark <i class="far fa-bookmark fas"></i></h3>
							<div class="row">
								<?php
									$qry = "SELECT * FROM bookmark_tbl WHERE user_id=$id ";
									...
									if (mysqli_num_rows($rs)>0) 
									{
										while ($row=mysqli_fetch_array($rs)) 
										{
											...
											{
												$postid = $row['post_id'];
												$qry1 = "SELECT * FROM posts_tbl WHERE id=$postid ";
								...
								<?php
									...
									{
										echo '<span class="ml-4" style="font-size:20px;">You have not bookmarked any posts yet.</span>';
										echo '<a href="index" class="btn theme-btn-inverse ml-5">Go to Home</a>';
									}
								?>
							</div>
						</div>
...
<?php	
	...
	if (isset($_POST['comment-submit'])) 
	{
		...
		if ($res) 
		{
			echo '<script>window.location.href = "bookmark"</script>';
		}
		else
		{
