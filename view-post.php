					...
					<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
						...
						<div class="view-post-section" style="text-align: justify;">
							...
							<p style="margin-bottom: 30px;"><?php echo $row['content1']; ?></p>
								<?php echo "<img src='img/".$row['img1']."' class='img-fluid d-block mx-auto w-50' width='150' >" ?>
							<p style="margin-top: 30px; margin-bottom: 30px;"><?php echo $row['content2']; ?></p>
								<?php echo "<img src='img/".$row['img2']."' class='img-fluid d-block mx-auto w-50' width='150' >" ?>
								...
								<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 px-0">
									<p class="card-text"><a href="https://twitter.com/TechNotify_in" class="author-link"><?php echo $row['author'] ?></a><span class="post-time"><?php $date=$row['doi']; echo date("F d, Y", strtotime($date)); ?></span></p>
											...
											<div class="post-feedback">
												...
												<div class="feedback-group px-xl-5 px-lg-4 px-md-5 pr-sm-5 pr-5" id="like">
												...
												<div class="feedback-group px-xl-5 px-lg-4 px-md-5 pr-sm-5 pr-5">
												...
												<div class="feedback-group px-xl-5 px-lg-4 px-md-5 pr-0">
...
<?php
	if (isset($_POST['dislike'])) 
	{
		...
		if (isset($_SESSION['userid'])) 
		{
			...
			$query3 = "SELECT * FROM likes_tbl WHERE user_id=$user_id AND post_id=$post_id";
